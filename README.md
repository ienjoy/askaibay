...
打开 [forms.google.com](https://forms.google.com) 新建表单，标题比如"湾区租房 · 免费发布房源"。
按下面加问题——**措辞可以改，但括号里的关键词要保留**，脚本靠关键词认列：

| 问题 | 类型 | 必填 | 说明 |
|---|---|---|---|
| 房源**标题** | 简答 | 是 | 例："Fremont 主卧带独卫，近 Ohlone College" |
| 每月**租金** | 简答 | 否 | 填数字就行，比如 `1800` |
| **城市**/地区 | 简答 | 是 | 中英文都认，例：Fremont、屋仑 |
| **邮编** | 简答 | 否 | 填了定位更准（邮编级 vs 城市级） |
| 出租**类型** | 单选 | 否 | 整租 / 单间 / 合租 |
| **联系**方式 | 简答 | 是 | ⚠️ 会公开显示在地图上 |
| 房源**说明** | 段落 | 否 | 只取前 120 字 |
| 详情**链接** | 简答 | 否 | 有原帖或相册就填 |

> **重要**：设置里**不要**打开"收集电子邮件地址"。下一步表格要公开，
> 打开了会把提交者的邮箱也一起公开。
>
> 联系方式一栏建议在问题描述里写清楚："此项会公开显示在地图上，
> 建议填微信号，不想公开手机号就别填"。
